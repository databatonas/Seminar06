...
try /* Блок обработки исключений.*/
{
    ...
    PrintArray(array);            /*Вызываем метод вывода на печать массива, который мы описали ниже, 
                                    с наименованием созданного массива (array) */
    CopyElement(array, array1);   /*Вызываем метод поэлементного копирования массива, который 
                                    мы описали ниже, с наименованием созданного массива (array) */
    PrintArray(array1);           /*Вызываем метод вывода на печать массива, который мы описали ниже, 
                                    с наименованием скопированного массива (array1) */
 ...
 диапозона заполнения массива.*/
    ...
    void CopyElement(int[] array, int[] array1)
    {
        for (int i = 0; i < array.Length; i++)  /* Вводим переменную (i)- это позиция первого элемента 
        массива. До тех пор, пока позиция элемента массива меньше длины массива, увеличиваем 
